...
# Deploy VLAN network configurations using access point configuration files
...
usage() {
    ...
    echo ""
    echo "Deploy network VLAN configuration to OpenWrt access points using AP config files."
    echo ""
    echo "Options:"
